    ...
    <div class="w-full grid--auto-cols gap-8">
        <card>
            <p class="text-gray-600 dark:text-white        text-sm">
                ...
                illum totam nulla, sunt enim numquam eveniet animi nostrum eius quia
                laborum ex facilis aspernatur? Alias eos error voluptatibus
                repudiandae quia.
            </p>
        </card>
        <card>
            <template #header>
                <h1 class="text-2xl font-semibold text-gray-600 dark:text-white   ">Some header</h1>
            </template>
            <p class="text-gray-600 dark:text-white    text-sm">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus
                illum totam nulla, sunt enim numquam eveniet animi nostrum eius quia
        ...
        <card>
            ...
            <template #footer>
                <h1 class="text-2xl font-semibold text-gray-600 dark:text-white   ">Some footer</h1>
            </template>
        </card>
    </div>
</div>
        ...
        <card>
            ...
            <template #footer>
                <div class="flex space-x-8 ml-4 items-end justify-around">
                    <IconFavorite height="24" width="24" class="text-gray-600 dark:text-white    cursor-pointer hover:text-purple-600" />
                    <IconChat height="24" width="24" class="text-gray-600 dark:text-white    cursor-pointer hover:text-purple-600" />

                    <IconShare height="24" width="24" class="text-gray-600 dark:text-white    cursor-pointer hover:text-purple-600" />
                </div>
            </template>
        </card>
        <card>
    ...
    <div class="w-full grid--auto-cols gap-4">
        ...
        <card>
            <template #header>
                <div class="flex space-x-2 items-center w-full justify-between pb-4">
                    ...
                    <w-btn circle text>
                        <IconOverflowMenuVertical height="24" width="24" class="justify-self-end text-gray-600 dark:text-white    cursor-pointer" />
                    </w-btn>
                </div>
            </template>
            <template #media>
        ...
        <card>
            ...
            <div>
                ...
                <p class="text-gray-600 dark:text-white    text-sm py-1">
                    Aflou is a town and commune in Laghouat Province, Algeria. It is
                    located in the Amour Range of the Saharan Atlas, at an elevation of
                    1,426 m, which makes it one of the highest towns in Algeria. Aflou
                    is the capital of Aflou District. Its population in 1998 was 48,000
                </p>
            </div>
            <template #footer>
                <div class="flex ">
...
<div class="space-y-2">
    <h1 class="section__title">Cards with Media aside:</h1>
    <div class="w-full grid  gap-4 place-items-start">
        <card>
            ...
            <div class="h-full ">
                ...
                <p class="text-gray-600 dark:text-white    text-md leading-snug ">
